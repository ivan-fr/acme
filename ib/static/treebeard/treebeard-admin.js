...
// Ok, let's do eeet
    ...
    var ACTIVE_NODE_BG_COLOR = '#B7D7E8';
    var RECENTLY_MOVED_COLOR = '#FFFF00';
    var RECENTLY_MOVED_FADEOUT = '#FFFFFF';
    var ABORT_COLOR = '#EECCCC';
    var DRAG_LINE_COLOR = '#AA00AA';

    var RECENTLY_FADE_DURATION = 2000;
...
// This is the basic Node class, which handles UI tree operations for each 'row'
    ...
    $(document).ready(function () {
        ...
        $('td.drag-handler span').addClass('active').bind('mousedown', function () {
            var $ghost = $('<div id="ghost"></div>');
            var $drag_line = $('<div id="drag_line"><span></span></div>');
            $ghost.appendTo($body);
            ...
            $body.disableSelection().bind('mousemove', function (evt2) {
                ...
                $('tr', node.$elem.parent()).each(function (index, element) {
                    ...
                    if (evt2.pageY >= rtop && evt2.pageY <= rtop + rowHeight / 2) {
                        ...
                        $targetRow = $row;
                        var target_node = new Node($targetRow[0]);
